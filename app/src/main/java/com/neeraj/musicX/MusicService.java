...
import com.neeraj.musicX.helpers.MediaButtonIntentReceiver;
import com.neeraj.musicX.helpers.MusicPlaybackTrack;
import com.neeraj.musicX.permissions.Nammu;
import com.neeraj.musicX.provider.MusicPlaybackState;
import com.neeraj.musicX.provider.RecentStore;
import com.neeraj.musicX.provider.SongPlayCount;
...
import com.neeraj.musicX.utils.TimberUtils.IdType;
    ...
    private Notification buildNotification() {
        ...
        if (TimberUtils.isLollipop()) {
            ...
            Notification.MediaStyle mediaStyle = new Notification.MediaStyle()
                    .setMediaSession((MediaSession.Token) mSession.getSessionToken().getToken())
